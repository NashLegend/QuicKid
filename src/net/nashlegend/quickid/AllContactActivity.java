...
import net.nashlegend.quickid.adapter.AllContactsAdapter;
...
import net.nashlegend.quickid.util.PinnedHeaderListView;
import net.nashlegend.quickid.view.SideBar;
