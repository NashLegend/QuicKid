...
import net.nashlegend.quickid.MainActivity;
import net.nashlegend.quickid.util.ContactHelper;
import net.nashlegend.quickid.view.DialpadKeyButton;
...
//            System.out.println("Oops");
     ...
     * animation puts the "dial" button in the parent. The parent calls
     * dialButtonPressed() and optionsMenuInvoked() on the dialpad fragment when
     * appropriate. TODO: Refactor the app so this interchange is a bit cleaner.
     */
