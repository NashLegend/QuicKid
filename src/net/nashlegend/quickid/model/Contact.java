...
package net.nashlegend.quickid.model;
...
import net.nashlegend.legendutils.Tools.TextUtil;
...
public class Contact {
    ...
    public List<String> fullNamesString = new ArrayList<String>();// String是带空格的
                                                                  ...
                                                                  // Chong,Zhang
                                                                  // Zhong}
    public List<ArrayList<String>> fullNameNumber = new ArrayList<ArrayList<String>>();// 如(重){94664}{24664}
    ...
    /*
     * (non-Javadoc)
     * @see java.lang.Object#clone() 复制一个同样的Contact
     */
